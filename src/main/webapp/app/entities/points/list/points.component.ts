...
export class PointsComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.points = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IPoints[] | null): IPoints[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    if (this.currentSearch && this.currentSearch !== '') {
      ...
      return this.pointsService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
    }
  }
