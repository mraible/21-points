...
import { sampleWithRequiredData } from '../points.test-samples';
...
describe('Points Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'points', component: PointsComponent }]), HttpClientTestingModule, PointsComponent],
      providers: [
        {
