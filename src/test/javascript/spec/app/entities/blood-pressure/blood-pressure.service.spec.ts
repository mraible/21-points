    ...
    describe('BloodPressure Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a BloodPressure', () => {
                service.create(new BloodPressure(null)).subscribe(received => {
            ...
            it('should update a BloodPressure', () => {
                service.update(new BloodPressure(123)).subscribe(received => {
            ...
            it('should return a BloodPressure', () => {
            ...
            it('should return a list of BloodPressure', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new BloodPressure(123)]);
            });
