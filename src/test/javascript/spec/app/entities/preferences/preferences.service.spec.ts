    ...
    describe('Preferences Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Preferences', () => {
                service.create(new Preferences(null)).subscribe(received => {
            ...
            it('should update a Preferences', () => {
                service.update(new Preferences(123)).subscribe(received => {
            ...
            it('should return a Preferences', () => {
