    ...
    describe('Weight Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/weights';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Weight', () => {
                service.create(new Weight(null)).subscribe(received => {
            ...
            it('should update a Weight', () => {
                service.update(new Weight(123)).subscribe(received => {
