...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '20a8a470-26f7-452b-beb2-cf010e2ab150' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('b4591fc3-ec16-4754-b790-85861ca88ee0');
      cy.get(`[data-cy="name"]`).should('have.value', 'b4591fc3-ec16-4754-b790-85861ca88ee0');
