...
describe('BloodPressure e2e test', () => {
  ...
  const bloodPressureSample = { timestamp: '2016-08-30T09:56:30.043Z', systolic: 41147, diastolic: 37309 };
  ...
  describe('BloodPressure page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('edit button click should load edit BloodPressure page', () => {
  ...
  describe('new BloodPressure page', () => {
    ...
    it('should create an instance of BloodPressure', () => {
      cy.get(`[data-cy="timestamp"]`).type('2016-08-30T11:41').should('have.value', '2016-08-30T11:41');

      cy.get(`[data-cy="systolic"]`).type('65735').should('have.value', '65735');

      cy.get(`[data-cy="diastolic"]`).type('23590').should('have.value', '23590');
