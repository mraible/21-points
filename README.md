...
This application was generated using [JHipster 7.8.0](https://www.jhipster.tech/2022/04/01/jhipster-release-7.8.0.html), and serves as the sample application in the [JHipster Mini-Book](https://www.infoq.com/minibooks/jhipster-mini-book).
...
To build the final jar and optimize the 21-Points Health application for production, run:
